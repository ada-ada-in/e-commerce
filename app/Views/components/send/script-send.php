    ...
    return 'Rp ' + number.toLocaleString('id-ID');
     ...
     function filter() {
        ...
        $('#downloadPdf').on('click', function () {
            ...
            const url = `/api/v1/delivery/send/print?startDate=${encodeURIComponent(startDate)}&endDate=${encodeURIComponent(endDate)}`;
