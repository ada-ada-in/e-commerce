<script>
    $(function () {
        ...
        function displayTable(data) {
            ...
            $('#transactions-cancel-data').html(row);
        ...
        function loadData() {
            $.ajax({
                url: '/api/v1/transactions/cancel',
                type: 'GET',
                dataType: 'json',
    ...
    $('#transactions-edit').on('click', function () {
        ...
        $.ajax({
            url: '/api/v1/transactions/cancel/date',
            type: 'GET',
            dataType: 'json',
            data: {
            ...
            success: function (response) {
                const tbody = $('#transactions-cancel-data');
                tbody.empty();
        ...
        $('#downloadPdf').on('click', function () {
            ...
            const url = `/api/v1/transactions/cancel/print?startDate=${encodeURIComponent(startDate)}&endDate=${encodeURIComponent(endDate)}`;
