<script>
    ...
    return 'Rp ' + number.toLocaleString('id-ID');
      ...
      function filter() {
        ...
        $.ajax({
            url: '/api/v1/delivery/pickup/date',
            type: 'GET',
            dataType: 'json',
            data: {
        ...
        $('#downloadPdf').on('click', function () {
            ...
            const url = `/api/v1/delivery/pickup/print?startDate=${encodeURIComponent(startDate)}&endDate=${encodeURIComponent(endDate)}`;
