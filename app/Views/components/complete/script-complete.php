<script>
    ...
    function filter() {
        ...
        $.ajax({
            url: '/api/v1/delivery/complete/date',
            type: 'GET',
            dataType: 'json',
            data: {
        ...
        $('#downloadPdf').on('click', function () {
            ...
            const url = `/api/v1/delivery/complete/print?startDate=${encodeURIComponent(startDate)}&endDate=${encodeURIComponent(endDate)}`;
