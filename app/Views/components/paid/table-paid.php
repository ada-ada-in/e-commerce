                    ...
                    <div class="col-12">
                        <div class="card border border-0">
                            <div class="card-header bg-white">
                                ...
                                <h4 class="card-title">paid Datatable</h4>
                                <input type="text" id="searchInput" class="form-control w-25" placeholder="Cari transaksi paid...">
                                <div>
                                    ...
                                    <li><a class="dropdown-item" id="downloadPdf" href="#" id>PDF</a></li>
                                    </ul>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="display table table-striped table-responsive-sm" style="min-width: 845px">
                                        ...
                                        <tbody id="transactions-paid-data">
                                            <!-- data paid -->
                                        </tbody>
                                    </table>
                                    <div>
